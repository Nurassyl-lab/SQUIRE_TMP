...
- Conda environment \
Tip: `conda create -n env_name python=3.12.0` to create a conda environment named `env_name` with Python 3.12.0
...
- Change `ROOT=path/REPO_ROOT_FOLDER` to the correct path of your cloned repository root directory.
